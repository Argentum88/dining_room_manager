...
class CodeGuy extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
     ...
     *
    * Conditional Assertion: Test won't be stopped on fail
     * @see Codeception\Module\CodeHelper::seeMyVar()
     * @return \Codeception\Maybe
     */
    public function canSeeMyVar($var) {
        $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('seeMyVar', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function seeMyVar($var) {
        $this->scenario->addStep(new \Codeception\Step\Assertion('seeMyVar', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
